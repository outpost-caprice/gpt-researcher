...
def generate_report_prompt(question, research_summary, report_format="apa"):
    ...
    return f'Information: """{research_summary}"""\n\n' \
           ...
           f' in depth, with facts and numbers if available and a minimum of 2,500 characters. However, if the number of characters are specified in "{question}" , please follow it. \n' \
...
def generate_resource_report_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Based on the above information, generate a bibliography recommendation report for the following' \
           ...
           f' The report should have a minimum length of 2,500 characters. However, if the number of characters are specified in "{question}" , please follow it.'
...
def generate_outline_report_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Using the above information, generate an outline for a research report in Markdown syntax'\
           ...
           f' The research report should be detailed, informative, in-depth, and a minimum of 2,500 characters. However, if the number of characters are specified in "{question}" , please follow it.' \
